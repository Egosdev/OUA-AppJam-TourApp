...
/// This class is used in the [newtourspage_item_widget] screen.
class NewtourspageItemModel extends Equatable {
  NewtourspageItemModel({
    ...
    mart1 = mart1 ?? ImageConstant.imgStar2;
    id = id ?? "";
  }
  ...
  NewtourspageItemModel copyWith({
    String? gapRYasTuru,
    String? ankaraHareketli,
    bool? isSelectedSwitch,
    String? mart,
